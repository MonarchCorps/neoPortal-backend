...
<body
    ...
    <div
        ...
        <p>Best regards,<br>Neo Portal Team</p>
    </div>
...
<body
    ...
    <div
        style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
        <p>Hello,</p>
        <p>Thank you for signing up on neo portal!😇</p>
        <p>We hope you make full use of our services and get the best out of it.</p>
        <p>You can also contact us through our help center.</p>
        <p>Best regards,<br>Neo Portal Team</p>
    </div>
    <div style="text-align: center; margin-top: 20px; color: #888; font-size: 0.8em;">
        <p>This is an automated message, please do not reply to this email.</p>
...
module.exports = { VERIFICATION_EMAIL_TEMPLATE, PASSWORD_RESET_SUCCESS_TEMPLATE, PASSWORD_RESET_REQUEST_TEMPLATE, WELCOME_EMAIL_TEMPLATE }